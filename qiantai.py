...
def qiantai(id):
    while 1:
        ...
        msg='前台'+str(id)+'号，你已登录立天大酒店，你可选择以下功能'
        title = "前台登录页面"
...
#为客人服务------------------------------------------------------------------------------------------------------------------------------------------#
        if(answer0 =="为客人服务"):
            while 1:
                ...
                cur.close()
                con.close()
                guest.guest(int(vip),int(answer1))
                break

#查询房间价格------------------------------------------------------------------------------------------------------------------------------------------#
        if(answer0 =="查询房间价格"):
            while 1:
                m = chaxun2.display_price(cursor)
                g.msgbox(m)
                break
                ...
                if(answer2 == '根据姓名查询客人详细信息'):
                    while 1:
                        ...
                        while 1:
                            ...
                            name = "'"+ name + "'"
                            k = reserve.panduan_shuru(cursor,str(name),'guest','name')
                            if(back==2):
                                break
                            if(k==1):
                                break
                                ...
                                back=back+1
                                g.msgbox('您的输入有误，请点击‘OK’，然后重新输入')
                        if(back==2):
                            g.msgbox("错误次数多已退出")
                            break
                        else:
                            m = chaxun2.display_guest_name(cursor,name)
                            g.msgbox(m)
                            break
                ...
                if(answer2 =='根据ID查询客人详细信息'):
                    while 1:
                        ...
                        while 1:
                            ...
                            k = reserve.panduan_shuru(cursor,str(id),'guest','id')
                            if(back==2):
                                break
                            if(k==1):
                                break
                        ...
                        if(back==2):
                            ...
                            m = chaxun2.display_guest_id(cursor,id)
                            g.msgbox(m)
                            break
